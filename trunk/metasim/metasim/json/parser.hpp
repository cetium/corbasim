...
#ifndef METASIM_JSON_PARSER_HPP
#define METASIM_JSON_PARSER_HPP

#include <list>
#include <boost/shared_ptr.hpp>
#include <metasim/json/helper.hpp>
#include <metasim/json/detail/json.hpp>
#include <metasim/json/detail/json_parse.hpp>
...
struct semantic_state
{
    ...
    semantic_state(helper::helper_base * initial_helper)
    {
        ...
        state_struct ss;
        ss.s = csu::metasim::json::writer::BEGIN;
    ...
    {
        namespace w = csu::metasim::json::writer;

        std::string val(p);
        csu::metasim::json::parser::decode (val);
...
typedef csu::metasim::json::parser::State< semantic_state > state;

} // namespace json
} // namespace metasim

#endif /* METASIM_JSON_PARSER_HPP */
