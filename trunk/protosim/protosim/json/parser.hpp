...
#include <protosim/json/helper.hpp>
#include <protosim/json/detail/json.hpp>
#include <protosim/json/detail/json_parse.hpp>
#include <protosim/json/detail/json_writer.hpp>
...
struct semantic_state
{
    ...
    semantic_state(helper::helper_base * initial_helper)
    {
        ...
        state_struct ss;
        ss.s = csu::protosim::json::writer::BEGIN;
    ...
    {
        namespace w = csu::protosim::json::writer;
...
typedef csu::protosim::json::parser::State< semantic_state > state;
...
inline bool parse(T& t, const char * str, size_t size)
{
    ...
    return csu::protosim::json::parser::grammar::gram::match(_st);
}
